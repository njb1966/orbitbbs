...
void *ctrl_thread(void *arg)
{
  ...
  LOG_EXIT();
  // Virtual/PTY devices don't support modem control lines -- exit thread only.
  LOG(LOG_WARN, "Modem control monitoring unavailable (virtual device) -- DTR changes will not be detected");
  return NULL;
}
